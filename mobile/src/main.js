 ...
 class App extends React.Component {
   ...
   componentDidMount = () => {
     this.socket = io.connect(
       `https://${this.props.serverID}.ngrok.io/webrtcPeer`,
       {
         path: '/io/webrtc',
         query: {}
       }
           ...
           <View style={{...styles.buttonsContainer}}>
             ...
             <View style={{ flex: 1, }}>
               <TouchableOpacity onPress={this.createAnswer}>
                 <View style={{...styles.button, backgroundColor:this.sdp ? 'teal':'lightgray',}}>
                   <Text style={{ ...styles.textContent, color:this.sdp ? 'white':'#333' }}>Answer</Text>
                 </View>
               </TouchableOpacity>
             </View>
           </View>
